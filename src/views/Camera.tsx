...
import { setCurrentUser, clearCurrentUser, getRandomUser, setPicture } from '../state/session/actions';
...
const CameraPageBase: React.FC<Props> = ({ navigation, onSetPicture }) => {
...
const mapDispatchToProps = (dispatch: Dispatch) => ({
  ...
  onSetPicture: (uri : string) => {
    dispatch(setPicture(uri))
  }
});
